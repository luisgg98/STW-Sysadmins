...
let companiesArray = [
    {name:'El Limonero Bar', nif:'1', email:'ho@hol.com',password:'aaa',address: 'Avenida Nose 53',salt:'salty',category:'Testing', description: 'desc', service_duration: 0, schedule: {monday:{schedule_1:"0"},tuesday:{schedule_1:"0"},wednesday:{schedule_1:"0"},thursday:{schedule_1:"0"},friday:{schedule_1:"0"},saturday:{schedule_1:"0"},sunday:{schedule_1:"0"}}, location: {type:"string",coordinates:[4,5]}},
